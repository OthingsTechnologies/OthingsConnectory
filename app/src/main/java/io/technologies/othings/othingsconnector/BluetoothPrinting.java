    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSearchBluetoothDevices.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bluetoothDevice.filter(OthingsConnector.BluetoothDevice.BluetoothDevices.ALL).getAllBluetoothDevices(new OthingsConnector.BluetoothDevice.BluetoothDevicesListener() {
                    @Override
